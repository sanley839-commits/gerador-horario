...
with st.sidebar:
    ...
    turmas_input = st.text_input("Suas Turmas/Disciplinas", "Minha Grade")import streamlit as st
import pandas as pd
from datetime import datetime, timedelta
...
if 'grade_editavel' in st.session_state:
    ...
    st.download_button("📥 Baixar Planilha", csv, "meu_horario.csv", "text/csv")    if st.button("Gerar Horário Escolar"):
        dias = ["Segunda", "Terça", "Quarta", "Quinta", "Sexta"]
        grade_final = {}
